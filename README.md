...
5. The application sends a **GET request** to the ExchangeRate-API.
6. The latest exchange rate is retrieved and displayed.
7. The converted amount is calculated and shown instantly.



Project Objectives

The main objective of this project is to demonstrate how to integrate a third-party REST API into a web application. Specifically, it aims to:

- Retrieve real-time currency exchange data.
- Perform accurate currency conversions.
- Display exchange rate information in a user-friendly interface.
- Apply asynchronous programming using JavaScript Fetch API.
- Implement proper error handling during API communication.
